                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    <div className="login-box forgot-s">
                        ...
                        <div className="input-box input__forgotpassword">
                            <input type="text" className="input-field" placeholder='Nhập mã xác minh'{...register('code')} />
                            <input type="text" className="input-field" placeholder='Nhập mật khẩu mới' {...register('password')} />
                            <input type="text" className="input-field" placeholder='Xác nhận mật khẩu mới' {...register('confirmPassword')} />
