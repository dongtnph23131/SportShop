    ...
    <div className='body'>
       <div className="login-box">
        ...
        <div className="input-box">
            <input type="text" className="input-field" placeholder='Name' id="password"  required />
        </div>
        <div className="input-box">
        ...
        <div className="input-box">
            <input type="password" className="input-field" placeholder='ConfirmPassword' id="password"  required />
        </div>
