            ...
            <form onSubmit={handleSubmit(onSigup)}>
                <div className="login-box">
                    ...
                    <div className="input-box">
                        <input {...register('firstName')} type="text" className="input-field" placeholder='First name' id="First name" />
                        <p className='error'>{errors.firstName ? errors?.firstName.message : ""}</p>
                    </div>
                    <div className="input-box">
                        <input {...register('lastName')} type="text" className="input-field" placeholder='Last name' id="Lastname" />
                    ...
                    <div className="input-box">
                        <input {...register('confirmPassword')} type="password" className="input-field" placeholder='ConfirmPassword' />
