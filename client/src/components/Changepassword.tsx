        ...
        <div className="card-text">
          <form>
            ...
            <div className="form-group">
              ...
              <input type="password" className="form-control form-control-sm" id="repeatPassword" />
            </div>
            <button type="submit" className="btn btn-primary btn-block submit-btn">Confirm</button>
          </form>
        </div>
      </div>
    </div>
